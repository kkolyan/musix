...
Оценки треков для определения приоритета в неоднозначных ситуациях (когда за много треков дано одинаковое число голосов).
При суммировании оценки разных пользователей сводятся к одному знаменателю, т.е. давая высокую оценку одним трекам,
вы автоматически понижаете оценку при расчете остальных треков.
<div><%
